...
public class HKDFV1LocalCryptoProvider implements V1LocalCryptoProvider {
    ...
    private byte[] hkdfSha384(SecretKey sharedSecret, byte[] salt, String info) {
        ...
        return hkdfSha384.extractAndExpand(salt, sharedSecret.getEncoded(), info.getBytes(UTF_8), 32);
    }
