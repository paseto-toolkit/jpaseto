Contributing to JPaseto
======================================

Summary
-------
This document covers how to contribute to JPaseto project. These instructions assume you have a GitHub.com account, so if you don't have one you will have to create one. Your proposed code changes will be published to your own fork of the JPaseto project and you will submit a Pull Request for your changes to be added.
...
On your computer, follow these steps to setup a local repository for working on the JPaseto:
