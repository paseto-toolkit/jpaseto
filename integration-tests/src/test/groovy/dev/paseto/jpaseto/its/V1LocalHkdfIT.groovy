...
import dev.paseto.jpaseto.crypto.hkdf.HKDFV1LocalCryptoProvider
import dev.paseto.jpaseto.impl.DefaultPasetoV1LocalBuilder
...
class V1LocalHkdfIT {
    ...
    void officialVectorsV1LocalEncodeTest(String token, SecretKey secretKey, Map<String, Object> claims, Map<String, Object> footer, String name) {
        ...
        V1LocalCryptoProvider cryptoProvider = new HKDFV1LocalCryptoProvider()
        PasetoBuilder pasetoBuilder = new DefaultPasetoV1LocalBuilder(cryptoProvider)
